...
include C:/IPG/carmaker/win64-11.0.1/include/MakeDefs.win64

# Matlab version in use.
MATSUPP_MATVER  = R2020b
MATSUPP_NUMVER  = 90900
...
MATLAB_ROOT	= $(subst \,/,C:\Program Files\MATLAB\R2020b)
ALT_MATLAB_ROOT	= $(subst \,/,C:\PROGRA~1\MATLAB\R2020b)
MAKECMD         = "C:/IPG/carmaker/win64-11.0.1/bin/cmmake"
HOST            = ANY
BUILD           = yes
...
MODEL		= JenkinAcc
WRAPPER		= JenkinAcc_wrap
CLASS		= VehicleControl
DESCRIPTION	= "JenkinAcc"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
SRCS		= JenkinAcc_data.c rt_zcfcn.c
...
INC_CFLAGS	+= -I$(subst \,/,"C:\Users\GIRI~1.AIG\DOCUME~1\CICT\SESSIO~2\JENKIN~1\src")
INC_CFLAGS	+= -I$(subst \,/,"C:\Users\GIRI~1.AIG\DOCUME~1\CICT\SESSIO~2\JENKIN~1\src\JenkinAcc_CarMaker_rtw")
