...
static char const ThisModelKind[]       = "MyModel_F";
...
static void *
MyModel_New(struct tInfos *Inf, struct tSuspCfgIF *SuspCfgIF, char const *KindKey, char const *Pre)
{
...
static void *
MyModel_New_LR(struct tInfos *Inf, struct tSuspCfgIF *SuspCfgIF, char const *KindKey, char const *Pre)
{
    struct tMyModel *mp = NULL;
    char             MsgPre[64];
    char const      *ModelKind;
...
static void *
MyModel_New_FrcCpl(struct tInfos *Inf, struct tSuspCfgIF *SuspCfgIF, char const *KindKey, char const *Pre)
{
    struct tMyModel *mp      = NULL;
