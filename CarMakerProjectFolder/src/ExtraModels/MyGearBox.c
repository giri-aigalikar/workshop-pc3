 ...
 */
static void *
MyModel_New(tInfos *Inf, struct tPTGearBoxCfgIF *CfgIF, char const *KindKey, char const *Ident)
{
...
static int
MyModel_PreSimSetup(void *MP, struct tPTGearBoxPreSimIF *PreSimIF, struct tPTGearBoxIF *IF)
{
    struct tMyModel *mp = (struct tMyModel *) MP;
