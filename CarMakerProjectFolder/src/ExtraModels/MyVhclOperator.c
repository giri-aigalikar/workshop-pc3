...
static int
MyModel_PreSimSetup(void *MP, struct tVhclOperatorPreSimIF *PreSimIF, struct tVhclOperatorIF *IF)
{
    struct tMyModel *mp = (struct tMyModel *) MP;
...
static void *
MyModel_New(struct tInfos *Inf, struct tVhclOperatorCfgIF *CfgIF, char const *KindKey)
{
