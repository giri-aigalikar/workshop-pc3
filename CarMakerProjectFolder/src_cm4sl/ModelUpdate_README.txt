CM4SL and TM4SL models can be updated using the matlab scripts ModelUpdate_CM14.m
and ModelUpdate_TM14.m in your Simulink folder (src_cm4sl/src_tm4sl. The scripts
