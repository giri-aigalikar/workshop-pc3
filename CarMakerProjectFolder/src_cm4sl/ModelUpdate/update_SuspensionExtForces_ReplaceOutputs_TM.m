...
Parent_src = 'generic_truck_src/TruckMaker/IPG Vehicle/CarAndTrailer/Forces/External Suspension Forces';
Parent_trg = append(trg_mdl,'/TruckMaker/IPG Vehicle/CarAndTrailer/Forces');
...
for (j=1:numel(System_matches.trgBlck))
    if (strcmp(get_param(System_matches.trgBlck{j},'Name'),'Vehicle') && strcmp(get_param(System_matches.trgBlck{j}, 'Parent'), Parent_trg_temp))
        Parent_trg = append(trg_mdl,'/TruckMaker/Vehicle/IPG Vehicle/CarAndTrailer/Forces');
    end
end
...
Parent_src = 'generic_truck_src/TruckMaker/IPG Vehicle/CarAndTrailer/Forces';
